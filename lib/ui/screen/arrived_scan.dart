...
class ArrivedScan extends StatefulWidget {
  ArrivedScan({Key? key}) : super(key: key);

  @override
  _ArrivedScanState createState() => _ArrivedScanState();
}

class _ArrivedScanState extends State<ArrivedScan> {
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child:AppBar(
          ...
          title: Text('Arrived', style: TextStyle(color: Colors.white, fontSize: 18, fontFamily: 'bold'),),
          actions: [
            TextButton(
              onPressed: (){},
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            ...
                            child: Row(
                              children: [
                                Expanded(flex: 2, child: Container(width: 70,child: Text('Last Station*', style: TextStyle(color: Color(0xFFFEA422), fontSize: 14,fontFamily: 'bold'),))),
