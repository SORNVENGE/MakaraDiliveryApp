...
class DispatchScan extends StatefulWidget {
  DispatchScan({Key? key}) : super(key: key);

  @override
  _DispatchScanState createState() => _DispatchScanState();
}

class _DispatchScanState extends State<DispatchScan> {
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child:AppBar(
          ...
          title: Text('Dispatch', style: TextStyle(color: Colors.white, fontSize: 18,fontFamily: 'bold'),),
          actions: [
            TextButton(
              onPressed: (){},
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text('TestA', style: TextStyle(color: Colors.black54, fontFamily: 'base'),),
                              TextButton(
                                onPressed: (){},
